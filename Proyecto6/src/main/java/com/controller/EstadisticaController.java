	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (opcion.equals("verEstadistica")) {
			...
			try {
				...
				sql = "select nombreServicio, count(Servicios_idServicios) \r\n"
				...
				JFreeChart chart = ChartFactory.createBarChart("Servicios consumidos", "Servicios", "Magnitud", data,
			...
			try {
				...
				JFreeChart chart = ChartFactory.createBarChart("Servicios consumidos en la Red", "Servicios",
						"Magnitud de la trama", data, PlotOrientation.VERTICAL, true, true, false);
			...
			try {
				...
				JFreeChart chart = ChartFactory.createBarChart("Cantidad de peticiones hacia los dispositivos",
						"dispositivos", "Magnitud de la trama", data, PlotOrientation.HORIZONTAL, true, true, false);
			...
			try {
				...
				JFreeChart chart = ChartFactory.createLineChart("Trafico en la red", "Tiempo",
						"Cantidad de paquetes en (Bytes)", data, PlotOrientation.VERTICAL, true, true, false);
