...
<head>
  ...
  <link rel="canonical" href="https://codepen.io/stack-findover/pen/OJRvPQv">
        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              <span class="padding-bottom--15">Ingrese sus datos:</span>
              <form id="stripe-login">
                <div class="field padding-bottom--24">
                  <label >Usuario</label>
                 <input type="text" name="id_usuario" size="50">
                </div>
                <div class="field padding-bottom--24">
              ...
              <input type="password" name="nuevaContraseña" size="50">
                </div>
